...
const voo = new Voo("VB123", "São Paulo", "Rio de Janeiro", 
...
// Criar passageiros
const passageiroVIP = new PassageiroVIP("001", "Ana Silva", "12345678901", "ana@email.com", "11999999999", "VIP12345");
const passageiroComum = new PassageiroComum("002", "João Santos", "98765432109", "joao@email.com", "11888888888");
